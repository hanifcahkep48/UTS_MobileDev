package uts.hanif.mobile.network

import uts.hanif.mobile.activity.data_barang.data.ResultDataBarang
import uts.hanif.mobile.activity.login.data.ResultLogin
import uts.hanif.mobile.activity.penjualan.data.ResultKeranjang
import uts.hanif.mobile.activity.penjualan.data.ResultSearchBarang
import uts.hanif.mobile.activity.report.detail.data.ResultItemKeranjang
