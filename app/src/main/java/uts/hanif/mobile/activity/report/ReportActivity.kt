package uts.hanif.mobile.activity.report

import android.os.Bundle
import android.util.Log.d
import uts.hanif.mobile.R
import uts.hanif.mobile.activity.report.adapter.ReportAdapter
import uts.hanif.mobile.activity.report.detail.DetailReportFragment
import uts.hanif.mobile.activity.report.presenter.ReportPresenter
import uts.hanif.mobile.activity.report.presenter.ReportView
