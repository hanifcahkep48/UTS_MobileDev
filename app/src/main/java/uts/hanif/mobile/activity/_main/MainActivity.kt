...
import uts.hanif.mobile.activity._main.adapter.MenuAdapter
import uts.hanif.mobile.activity._main.presenter.MainPresenter
import uts.hanif.mobile.activity._main.presenter.MainView
import uts.hanif.mobile.activity.data_barang.DataBarangActivity
import uts.hanif.mobile.activity.login.LoginActivity
import uts.hanif.mobile.activity.penjualan.PenjualanBarang
import uts.hanif.mobile.activity.report.ReportActivity
